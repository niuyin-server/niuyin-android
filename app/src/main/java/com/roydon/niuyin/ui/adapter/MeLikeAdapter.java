...
import com.roydon.niuyin.http.response.MyLikeVideoVO;
 ...
 */
public class MeLikeAdapter extends MyAdapter<MyLikeVideoVO> {
    ...
    @NonNull
    @Override
    public MeLikeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MeLikeAdapter.ViewHolder();
    }

    final class ViewHolder extends MyAdapter.ViewHolder {

        ViewHolder() {
            super(R.layout.item_me_like);
        }
        ...
        public void onBindView(int position) {
            MyLikeVideoVO item = getItem(position);
