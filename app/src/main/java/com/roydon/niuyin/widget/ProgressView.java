...
public final class ProgressView extends View {
    ...
    private void setupBounds(int layoutWidth, int layoutHeight) {
        ...
        if (!mFillRadius) {
            ...
            mCircleBounds = new RectF(xOffset + mBarWidth, yOffset + mBarWidth, xOffset + circleDiameter - mBarWidth, yOffset + circleDiameter - mBarWidth);
        } else {
            mCircleBounds = new RectF(paddingLeft + mBarWidth, paddingTop + mBarWidth, layoutWidth - paddingRight - mBarWidth, layoutHeight - paddingBottom - mBarWidth);
        }
    }
