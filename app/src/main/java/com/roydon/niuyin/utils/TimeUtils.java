...
public class TimeUtils {
    ...
    public static final int[] LEVELS = {LEVEL_YEAR, LEVEL_MONTH, LEVEL_DAY, LEVEL_HOUR, LEVEL_MINUTE, LEVEL_SECOND,};
    ...
    public static final String[] LEVEL_NAMES = {NAME_YEAR, NAME_MONTH, NAME_DAY, NAME_HOUR, NAME_MINUTE, NAME_SECOND,};
    ...
    public static class Day {
        ...
        public static final int[] DAY_OF_WEEK_TYPES = {TYPE_SUNDAY, TYPE_MONDAY, TYPE_TUESDAY, TYPE_WEDNESDAY, TYPE_THURSDAY, TYPE_FRIDAY, TYPE_SATURDAY,};
    ...
    public static int[] getDateDetail(long time) {
        ...
        return new int[]{mCalendar.get(Calendar.YEAR),//0
    ...
    public static int[] getTimeDetail(long time) {
        final Calendar mCalendar = Calendar.getInstance();
        mCalendar.setTimeInMillis(time);
        return new int[]{mCalendar.get(Calendar.HOUR_OF_DAY),//3
